...
# model = ChatOpenAI(model="kimi-3.5", base_url="https://api.moonshot.cn", api_key=os.environ["KIMI_API_KEY"])

# DeepSeek: OpenAI-compatible hosted API
# No extra install needed (langchain-openai is already a default dep)
# Requires DEEPSEEK_API_KEY in .env  (get one at platform.deepseek.com)
from langchain_openai import ChatOpenAI
model = ChatOpenAI(model="deepseek-v4-flash", base_url="https://api.deepseek.com", api_key=os.environ["DEEPSEEK_API_KEY"])
